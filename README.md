...
Απαραίτητη προϋπόθεση είναι να έχετε εγκατεστημένη τη _Python_ στον υπολογιστή σας.
Μετά την αποσυμπίεση του φακέλου στον υπολογιστή σας, πλοηγηθείτε μέσα σε αυτόν από command line και εκτελέστε τη παρακάτω εντολή για να ξεκινήσετε την εφαρμογή:
